...
output_base_path = "/tmp/renders"  # Change to your preferred path
...
def setup_compositor_output(cam_name):
    ...
    map_range.inputs['From Min'].default_value = scene.camera.data.clip_start
    map_range.inputs['From Max'].default_value = scene.camera.data.clip_end
